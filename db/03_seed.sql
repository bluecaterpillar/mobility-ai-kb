...
-- Test scenarios:
--
--   1. SUV PHEV ~650€ / 48 mesi / 100k km
--      Filter the search RPC with: type=suv, motorization=phev,
--      target_fee=650, target_duration=48, target_km=100000, min_score=0.80.
--      Expected ranking (scores rounded to 2dp):
--        • Mattina Napoli (uploaded via the app in MS C) → 1.00 (perfect)
--        • Sofia Bari    — Volvo XC40 Recharge   → ≈ 0.91
--        • Andrea Trento — Cupra Formentor PHEV  → ≈ 0.89
--        • Giulia Padova — BYD SEAL U DM-i       → ≈ 0.88
--        • Marco Verona  — VW Tiguan diesel       → ≈ 0.86 (matches type/fee/duration but motor=diesel)
--      The diesel SUV intentionally surfaces as a near-match — the scoring
--      is soft so the agent can offer a non-PHEV alternative on similar
--      commercials.
--
--   2. City car benzina ~280€ / 36 mesi
--      Filter: type=city_car, motorization=benzina, target_fee=280,
--      target_duration=36.
--      Expected: Chiara Genova (Fiat Panda 1.2 8v Pop) → 1.00, then the
...
--
--   4. Empty filters + min_score 0 (the Browse view does this client-side)
--      Returns all 21 rows ordered by created_at desc.
--
-- ------------------------------------------------------------------------
-- IDEMPOTENCY
-- ------------------------------------------------------------------------
...
-- 1. Lorenzo Bologna · b2c · Toyota C-HR Hybrid (suv hybrid_benzina, 540 €/48mo/100k)
...
-- 2. Giulia Padova · b2c · BYD SEAL U DM-i (suv phev, 595 €/36mo/80k) — SUV-PHEV neighbour
...
-- 3. Marco Verona · b2b · VW Tiguan TDI (suv diesel, 580 €/48mo/120k) — diesel SUV alt
...
-- 4. Sofia Bari · b2c · Volvo XC40 Recharge (suv phev, 720 €/60mo/100k) — premium SUV-PHEV
...
-- 5. Andrea Trento · b2c · Cupra Formentor e-Hybrid (suv phev, 580 €/60mo/90k)
...
-- 6. Chiara Genova · b2c · Fiat Panda Pop (city_car benzina, 280 €/36mo/60k) — city benzina match
...
-- 7. Simone Cagliari · b2c · Citroen e-C3 (city_car elettrico, 320 €/36mo/60k)
...
-- 8. Davide Lecce · b2b · Fiat Panda GPL (city_car gpl, 295 €/36mo/75k)
...
-- 9. Elena Catania · b2c · BMW Serie 1 118d (berlina diesel, 480 €/48mo/100k)
...
-- 10. Alessio Trieste · b2b · Audi A3 35 TFSI (berlina benzina, 510 €/36mo/90k)
...
-- 11. Federica Pisa · b2b · Tesla Model 3 SR+ (berlina elettrico, 615 €/48mo/100k)
...
-- 12. Luca Brescia · b2b · Skoda Octavia SW TDI (sw diesel, 470 €/60mo/150k) — fleet workhorse
...
-- 13. Martina Modena · b2c · Volvo V60 B4 MHEV (sw hybrid_diesel, 615 €/48mo/100k)
...
-- 14. Beatrice Como · b2c · Mercedes Classe C SW MHEV (sw hybrid_diesel, 720 €/48mo/100k) — premium SW
...
-- 15. Stefano Treviso · b2c · VW T-Roc (crossover benzina, 425 €/36mo/75k)
...
-- 16. Valentina Parma · b2c · Hyundai Kona HEV (crossover hybrid_benzina, 460 €/48mo/100k)
...
-- 17. Roberto Rimini · b2b · Renault Captur GPL (crossover gpl, 380 €/48mo/120k)
...
-- 18. Caterina Salerno · b2c · Citroen C4 Picasso BlueHDi (monovolume diesel, 395 €/48mo/100k)
...
-- 19. Gianluca Ravenna · b2b · Fiat Doblò metano (monovolume metano, 365 €/60mo/150k)
...
-- 20. Silvia Ancona · b2b · Iveco Daily CNG (commercial metano, 540 €/60mo/150k) — fleet van
...
--
--   -- Scenario 1: SUV PHEV ~650€ 48mo 100k km
--   select customer_full_name, vehicle_full_name, monthly_fee, score
